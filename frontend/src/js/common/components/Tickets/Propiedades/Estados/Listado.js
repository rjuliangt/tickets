        ...
        return (
            <div className="d-flex flex-column w-100">
                ...
                <div className="d-flex flex-wrap mb-2 ">
                    <h3 className="txt-16-n color-003 w-50">Estados</h3>
