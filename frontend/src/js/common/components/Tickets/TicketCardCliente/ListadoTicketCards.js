...
class Ticket extends Component {
    componentWillMount = () => {
        this.props.listarTicketCliente();
    ...
    render() {
        ...
        //const datos = dataCliente.results;
                ...
                <div className="row ">
                              ...
                              {dataCliente !==null?
                                <div className="d-flex flex-column w-100">
                                    <LoadMask loading={loader} light>
                                        {dataCliente.results.map((proyecto) => (
                                            <Cards
                                                key={proyecto.asunto}
                                                datos={proyecto}
                                                actualizarSeleccion={
                                        ...
                                        <div className="tablaTicket">
                                            <Grid
                                                data={dataCliente}
                                                loading={loader}
                                                onPageChange={listarTicketCliente}
                                                page={page}
                    ...
                    {/* {(dataResumenPrioridad && dataResumenPrioridad.Results.total_tickets>0) &&  */}
                        <Selects
                            ...
                            resetearBuscadorCliente={resetearBuscadorCliente}
                            SetResetearBuscadorCliente={SetResetearBuscadorCliente}
                        />
